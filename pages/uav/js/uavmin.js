...
layui.use(['laydate', 'laypage', 'jquery', 'layer', 'table', 'carousel', 'upload', 'element'], function () {
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , { field: 'weight', title: '飞机重量(kg)' } 
            , { field: 'uavNum', title: '飞机数量' } 
            // , { field: 'imei', title: '设备号' }
        ...
        ,done:function(res, page, count) {
            $("[data-field='userType']").children().each(function () {
              ...
              $("[data-field='weight']").children().each(function () {
                if ($(this).text() == '') {
                  $(this).text("未启用")
                } 
              }),
              $("[data-field='uavNum']").children().each(function () {
                if ($(this).text() == '') {
                  $(this).text("未启用")
                } 
              })
    ...
    $(function () {
        $("#register").on('click', function () {
            $(location).attr('href', './../uavregister/minregister.html');
        });
